...
public class EditWorkoutViewAdapter extends RecyclerView.Adapter<EditWorkoutViewAdapter.WorkoutViewHolder> {

    private static final String TAG = "EditWorkoutViewAdapter";
    private Context context;
    private List<Exercise> exercises;
    private LayoutInflater inflater;
    private FragmentManager manager;

    public EditWorkoutViewAdapter(List<Exercise> exercises, Context context,FragmentManager manager) {
